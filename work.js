...
function emailvalidation() {
    ...
    if (email == "") {
        ...
        checkemail.innerHTML = "give a vaid email id";
        email_id = false
...
function phonevalidation() {
    ...
    if(isNaN(phonenum)){
        ...
        checkphone.innerHTML = "Only number allowed";

    }
    else if (phonenum == "") {
        checkphone.innerHTML = "Feild is requried";
        phone_num= false
        ...
        {
            checkphone.innerHTML = "number less than 10 "

        }
        else if(phonenum.length>10)
        {
            checkphone.innerHTML = "number greater than 10 "
        }
        else
        {
            checkphone.innerHTML = ""
